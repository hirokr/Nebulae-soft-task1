...
const Awards = () => {
  return (
    <div className="bg-gradient-to-b from-[#000429] to-[#00042a] py-28 px-10 flex flex-col justify-end items-center w-full">
      ...
      <div className="h-1 w-10/12 mt-3  mb-10 rounded bg-white"></div>
      ...
      <div className="h-1 w-10/12 mt-5 rounded bg-gray-500"></div>
      <h1 className="text-2xl font-bold mt-5">Expertise</h1>
      <div className="h-1 w-10/12 mt-5  mb-5 rounded bg-gray-500"></div>
